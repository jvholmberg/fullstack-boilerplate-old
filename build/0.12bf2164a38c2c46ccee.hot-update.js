...
/***/ function(module, exports, __webpack_require__) {
	...
	var compilerServer = (0, _webpack2.default)(_webpack4.default[0]);
	var compilerClient = (0, _webpack2.default)(_webpack4.default[1]);
	app.use((0, _webpackDevMiddleware2.default)(compilerServer, {
	  noInfo: true,
	  publicPath: _webpack4.default[0].output.publicPath
	}));
	app.use((0, _webpackHotMiddleware2.default)(compilerServer, {
	  log: console.log,
	  path: '/__webpack_hmr',
	  heartbeat: 10 * 1000
	}));
	app.use((0, _webpackDevMiddleware2.default)(compilerClient, {
	  noInfo: true,
	  publicPath: _webpack4.default[1].output.publicPath
	}));
	app.use((0, _webpackHotMiddleware2.default)(compilerClient, {
	  log: console.log,
	  path: '/__webpack_hmr',
	  heartbeat: 10 * 1000
	}));
...
//# sourceMappingURL=0.12bf2164a38c2c46ccee.hot-update.js.map