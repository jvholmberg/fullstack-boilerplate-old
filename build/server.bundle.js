...
/******/ 	var hotCurrentHash = "ff4d9a0c0b196acfbdb3"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var serverConfig = extend(true, {}, config, {
	  ...
	  entry: ['./server.js', hotMiddlewareScript],
	  output: {
	...
	*/
	var clientConfig = extend(true, {}, config, {
	  ...
	  entry: ['./client.js', hotMiddlewareScript],
	  output: {
...
/***/ function(module, exports) {
	...
	module.exports = require("webpack-hot-middleware/client?path=/__webpack_hmr&timeout=20000&reload=true");
